...
We want to make correct decisions quickly and consistently, especially during times of high stress.
This is really difficult to do if the team hasn't previously aligned on how to make these difficult decisions.

### Concept

Pre-align the team around a set of default decisions/positions that you make to resolve tough decisions and write them down.
The resulting document is a list of tenets that can be used as a reference during times of stress/contention to resolve arguments and make decisions quickly.
The document can also be shared with stakeholders and leadership to be more transparent about how you make decisions and to
give them an opportunity to give input/feedback.
...
There are many situations where you may make the opposite decision from what is in your tenets. Based on a context where the correct decision is clear.
...
prevents you from getting deadlocked by this mechansim which should be unblocking you.

This has the added benefit of communicating your values clearer to your stakeholders.
