---
title: Side effects in React-Redux
description: Some ways to perform side-effects in React-Redux.
date: 2021-02-14
lastEdit: 2021-02-14
faIcon: faAtom
guid: d95cce73-db6b-4aa6-9792-34c9f2fc703b
---
...
![simplified redux structure](./images/redux-structure-simplified.png)
...
![redux side effect structure](./images/redux-side-effect-conceptual-structure.png)
