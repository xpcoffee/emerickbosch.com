...
import ProducerConsumerSequence from "./images/producer-consumer-sequence.svg"

**TLDR** "Producer" and "consumer" form a <Link to="/articles/patterns">pattern</Link> which enables systems to decouple requests for work and when that work gets processed.
