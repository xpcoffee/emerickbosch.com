...
This way our tests do not need to know about the inner workings of the saga aside from integration with API.
I think this strongly reduces the brittleness of tests.
Also, we're using the contract that we'd use in the component I also think this improves the readability of the test.

<Card>
  <span className="quicksand">
    Thanks for reading! Do you have feedback or ideas on how to improve on this
    approach? Reach out to me!
  </span>
</Card>
