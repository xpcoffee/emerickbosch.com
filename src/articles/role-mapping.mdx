...
Role division & specialization often also results in consolidating specific knowledge/ability into fewer individuals, 
increasing the risk that the effectiveness of the group is impacted if a single individual is unable to make progress.
Finally, bounding these risks requires members of the team to have a shared understanding of the roles and their expectations. 
Miscommunication of responsibilities greatly increases all afore-mentioned risks.
There are no industry standards or certification requirements for most roles within the tech industry.

## The role-mapping protocol

The following protocal can be used for setting explicit expectations within a multi-role team that are relevant to the team's context:
...
## Limitations
 ...
 - The results of this protocol can result in expecations that are in tension with an individual's contractual expectations.
