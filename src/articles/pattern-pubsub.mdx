...
import SequenceDiagram from "./images/pubsub-sequence.svg"

**TLDR** "Publisher" and "subscriber" form a <Link to="/articles/patterns">pattern</Link> which enables objects to communicate asynchronously.
